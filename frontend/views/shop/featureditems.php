            ...
            <div class="swiper-slide w-full h-full flex md:flex-row flex-col">
                ...
                <div class="relative p-4 flex justify-center flex-col flex-grow">
                    ...
                    <div class="flex justify-between mt-6">
                        <button  @click="addToBasket(<?=$featuredItem["ID_ARTIKEL"] ?>)" class="w-1/4 p-2 bg-blue-500 hover:bg-blue-700 text-white text-2xl cursor-pointer rounded-full">V košarico</button>
