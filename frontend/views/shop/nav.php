        ...
        >
            <ul class="flex">
                <li class="flex items-center w-6 mx-4 relative">
                    ...
                    <div class="absolute top-7 left-5 rounded-full bg-red-700 h-5 w-5 flex justify-center items-center" x-show="filledBasket()">
                        <p id="basketCounter" class="text-white p-1 text-xs font-bold" x-text="st_artiklov"></p>
                    </div>
                </li>
